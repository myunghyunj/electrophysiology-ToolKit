...
+) Due to recent high traffic on this repo, I started translating these MATLAB codes to Python. MATLAB is still the convention in neuroscience. **Feel free to let me know if you find any errors or have suggestions.**
